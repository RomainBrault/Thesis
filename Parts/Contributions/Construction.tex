...
be used. However, as pointed out by~\citet{minh2016operator}, under some
...
rise to a bounded operator $A(\omega)$ and is idependant of the
...
$\mathcal{Y}$. In this proof we relax the assumptions
