...
\PassOptionsToPackage{eulerchapternumbers,listings,subfig,parts,linedheaders,floatperchapter,pdfspacing,dottedtoc}{classicthesis}
\usepackage[LGRgreek]{mathastext} % No italic for math
...
% \setmathsfont(Digits,Latin){CormorantGaramond-Medium}
% \setmathsfont(Latin){CormorantGaramond-Medium}
%
