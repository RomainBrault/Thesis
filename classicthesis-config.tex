...
\newcommand{\myFaculty}{Informatique, Biologie Int\'egrative et Syst\`emes Complexes (IBISC)\xspace}
\newcommand{\myDepartment}{Computer Science \xspace}
\newcommand{\myDoctoralSchool}{Sciences et Technologies de l'Information et de la Communication (STIC)\xspace}
\newcommand{\myUniUEVE}{Universit\'e-D'\'Evry-Val-D'Essonne \xspace}
\newcommand{\myUniTP}{T\'el\'ecom-ParisTech \xspace}
\newcommand{\myLocation}{15, Rue Plumet, 75015 - Paris, France\xspace}
\newcommand{\myTime}{\today\xspace}
\newcommand{\myVersion}{version 0.1\xspace}
\newcommand{\NNT}{201XSACLSXXX\xspace}
\newcommand{\EDN}{580\xspace}
...
pdftitle={\myTitle},
pdfauthor={\textcopyright\ \myName, \myUniUEVE, \myUniTP, \myFaculty},
pdfsubject={\mySubtitle},
pdfkeywords={Noyaux \`a Valeurs Op\'erateurs,%
Passage \`a l'\'echelle,%
