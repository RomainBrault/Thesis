...
\begin{proof}
    ...
    $\IFT{\inner{y', K_e(\cdot)y}_{\mathcal{Y}}}$ $=$ $\mathcal{F}^{-1}\mathcal{R}{\inner{y',
    K_e(\cdot)y}_{\mathcal{Y}}}$. By injectivity of the \acl{FT}, $K_e$ is even. Since
...
\begin{center}
    \begin{algorithm2e}[htb]\label{alg:ORFF_construction}
        \SetAlgoLined
