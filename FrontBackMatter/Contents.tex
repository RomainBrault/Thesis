...
\acro{OVK}{Operator-Valued Kernel}.
\acro{RFF}{Random Fourier Feature}.
\acro{ORFF}{Operator-valued Random Fourier Feature}.
\acro{POVM}{Positive Operator-Valued Measure}
\acro{RKHS}{Reproducing Kernel Hilbert Space}.
\acro{vv-RKHS}[$\mathcal{Y}$-RKHS]{$\mathcal{Y}$-Reproducing Kernel Hilbert Space}.
\acro{LCA}{Locally Compact Abelian}.
