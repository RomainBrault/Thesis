...
\begin{textblock}{11.5} (2, 1.5)
    ...
    Fourier Features
    \begin{multicols}{2}
        \emph{Abstact:} Many problems in Machine Learning can be cast into
        ...
        memory capacity. In this thesis, we propose and study scalable methods
    ...
    \begin{multicols}{2}
        ...
        elle n\'ec\'essite une quantit\'e de m\'emoire \'evoluant
        ...
        parti d'une fonction de redescription charact\'etisant le \emph{noyau
