...
\caption[Relationships between feature-maps.]{Relationships between feature-maps. $\tildeH{\omega} = \Set{\frac{1}{\sqrt{D}}\Vect_{j=1}^Dg(\omega_j)| \forall g\in L^2\left(\dual{\mathcal{X}}, \probability_{\dual{\Haar},\rho}, \mathcal{Y}'\right) }$.}
