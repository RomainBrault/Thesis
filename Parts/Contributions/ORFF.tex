...
=\prod_{k=1}^d\int_{(-c_k;+\infty)^d}\frac{\exp\left(-\iu\inner{\log(\delta_k+c_k),\omega_k}\right)}{t_k + c_k}\frac{2}{\sqrt{\delta_k+c_k}+\sqrt{\frac{1}{\delta_k+c_k}}}\frac{d\Leb(\delta_k)}{\sqrt{2\pi}^d}\Gamma_{ij}
\end{dmath*}
