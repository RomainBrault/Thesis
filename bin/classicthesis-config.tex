...
\makeatletter
\tikzset{
  column sep/.code=\def\pgfmatrixcolumnsep{\pgfxscale*(#1)},
  row sep/.code   =\def\pgfmatrixrowsep{\pgfyscale*(#1)},
  matrix xscale/.code=%
    \pgfmathsetmacro\pgfxscale{\pgfxscale*(#1)},
  matrix yscale/.code=%
    \pgfmathsetmacro\pgfyscale{\pgfyscale*(#1)},
