...
signature of $K$ and $k$ on the additive group
$\mathcal{X}=(\mathbb{R}^d,+)$~---~$\acs{ie}~\delta=x-z$ and $e=0$. The well
known Gaussian kernel is defined for all $\delta\in\mathbb{R}^d$ as follows:
\begin{dmath*}
