...
\begin{landscape}
    \begin{figure}[tb]
        ...
        \caption[\acs{ORFF} equivalence theorem]{ORFF equivalence theorem}
        \label{fig:representer}
    \end{figure}
    \clearpage
    \begin{figure}[tb]
        \pyc{print(r'\centering\resizebox{\textheight}{!}{\input{./representer2.pgf}}')}
        \caption[\acs{ORFF} equivalence theorem with overfitting]{ORFF
        equivalence theorem with overfitting}
        \label{fig:representer}
    \end{figure}
\end{landscape}}
